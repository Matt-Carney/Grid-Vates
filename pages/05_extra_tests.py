...
def contour_data(mu = 20, sigma=1, time_fraction=(1/24), deacay=1.0, size=1000, bins=10, type = 'sine', rand='index'):
...
d, t, n = contour_data(mu=vel_mean, sigma=vel_sd, size=sz, rand='index')
